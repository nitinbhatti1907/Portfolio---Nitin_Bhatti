...
- Developed ML models in **Python** (**pandas**, **scikit-learn**, **NumPy**) for **classification** and **anomaly detection** use cases.
- Partnered with stakeholders to translate requirements into scalable data solutions; improved pipeline quality and reliability.
- Performed data cleansing and optimization to deliver high-quality datasets for analytics and reporting.